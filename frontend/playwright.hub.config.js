...
export default defineConfig({
	...
	testMatch: /hub-(pages|agent-signup|remaining-coverage|keycloak-sync|provisioning-personas|profile-updates)\.spec\.ts|step(2|3|4)-(cross-council-hub|agent-quote|pre-application-meeting)\.spec\.js/,
	timeout: 90 * 1000,
	fullyParallel: false,
	workers: 1,
